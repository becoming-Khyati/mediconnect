...
from .serializers import PatientSerializer, PrescriptionSerializer, DoctorSerializer, AppointmentSerializer, NotificationSerializer, HealthReportSerializer
...
class PatientListAPIView(generics.ListCreateAPIView):
    ...
    def perform_create(self, request, *args, **kwargs):
        ...
        # Create Patient Linked to that user
...
class PatientPrescriptionAPIView(generics.ListAPIView):  # ✅ FIXED NAME
    serializer_class = PrescriptionSerializer
...
def book_appointment(request):
    ...
    if Appointment.objects.filter(doctor_id=doctor_id, date=date, time=time, status="booked").exists():
...
def profile_view(request):
    ...
    if user.role == "doctor":
        ...
        if request.method == "GET":
            ...
            user.specialization = request.data.get("specialization")
    ...
    # -------- PATIENT --------
        ...
        if request.method == "GET":
            ...
            patient.name = request.data.get("name")
